...
No caso, os modelos assumem a existência de homens, mulheres e crianças, caracterizados por diversos atributos, conforme definido na Tabela 1.
...
\begin{table}[H]
	...
	\textbf{Atributos}           & \textbf{Tipo}  & \textbf{Descrição}                                                                                                                                   \\ \midrule
		...
		\rowcolor[HTML]{FFFFFF} 
		conhecimento da área & float & \begin{tabular}[c]{@{}l@{}}{[}0, 1{]} \\probabilidade de seguir o caminho\\ correto até à saída mais próxima\\\end{tabular}                                                                                                                                     \\
		\rowcolor[HTML]{FFFFFF} 
		independência        & float   & \begin{tabular}[c]{@{}l@{}}{[}0, 1{]} \\probabilidade de seguir outros\\\end{tabular}  \\ 
		\rowcolor[HTML]{FFFFFF} 
...
\item Empurrar;
	...
	Uma pessoa pode empurrar uma pessoa no seu caminho, derrubando-a.
	Uma pessoa que seja derrubada verá a sua integridade física diminuída. 

\item Ajudar;

	Uma pessoa pode ajudar outra, seja ajudando-a a levantar-se ou guiando-a até à saída, caso em que a mobilidade da pessoa altruísta fica diminuída.
