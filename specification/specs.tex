...
Adicionalmente, irá utilizar-se a \textit{API SAJaS}, que se propõe facilitar o desenvolvimento de sistemas multiagente, oferecendo funcionalidades \textit{JADE}. 
...
Empurrar (uma pessoa empurra uma pessoa no seu caminho); 
Guiar (uma pessoa pode ajudar outra); 
Gritar (o facto de uma pessoa gritar pode aumentar o estado de pânico das pessoas em redor);
...
Por fim, iniciou-se a fase de implementação, com uma primeira definição dos agentes e espaço a evacuar.
...
\subsection{Software}
[1] \textit{Repast Simphony Plugin for Eclipse}.
