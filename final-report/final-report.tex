...
\begin{table}[H]
	...
	\caption{Atributos dos agentes implementados.}
	\begin{tabular}{@{}lll@{}}
		\toprule
	...
	\textbf{Atributos}           & \textbf{Tipo}  & \textbf{Descrição}                                                                                                                                   \\ \toprule
		...
		\rowcolor[HTML]{FFFFFF} 
		mobilidade   & int & \begin{tabular}[c]{@{}l@{}}{[}0, 100{]}\\ condiciona a velocidade a que se move\end{tabular} \\
		\midrule
		\rowcolor[HTML]{FFFFFF} 
		fadiga               & int & \begin{tabular}[c]{@{}l@{}}{[}0, 100{]}\\  condiciona a velocidade a que se move\end{tabular}            \\ \midrule
		\rowcolor[HTML]{FFFFFF} 
		estado de pânico     & int & \begin{tabular}[c]{@{}l@{}}{[}0,100{]}\\ condiciona a velocidade a que se move\end{tabular}                                                   \\ \midrule
		\rowcolor[HTML]{FFFFFF} 
		velocidade inicial   & float & condicionada pelo género e pela idade                                                                                                         \\ \midrule
		\rowcolor[HTML]{FFFFFF} 
		velocidade máxima    & float & condicionada pelo género e pela idade    \\ \midrule                                                                                                    
	\end{tabular}
...
\begin{table}[H]
	\centering
	\label{agent-types}
	\caption{Diferentes tipos de agente.}
	\begin{tabular}{@{}lll@{}}
		\toprule
		\rowcolor[HTML]{FFFFFF} 
		\textbf{Tipo}  & 
...
Estes protocolos são relativamente simples, não sendo uma negociação na verdadeira aceção da palavra. De referir, ainda, que as interações Ajudar e Orientar são efetuadas de acordo com o modelo de Rede Contratual, sendo que, no caso, o papel de gestor cabe ao agente que faz o pedido inicial. 
...
\textbf{JADE} Definição de agentes.

\textbf{Repast Simphony} Simulação multi-agente.

\textbf{SAJaS} Integração de agentes JADE com Repast.
\newline
