...
Ao longo do processo de desenvolvimento foram levadas a cabo múltiplas experiências, com vista a testar a implementação dos agentes. O espaço utilizado para os testes levados a cabo nesta fase encontra-se definido em\textit{ src/maps/testMap.map}.
\begin{itemize}
...
\begin{itemize}
	%----------------------------------------------------------------------------------------	
	\item \textbf{População conhecedora do local}

\textbf{Objetivo:} 
Testar o comportamento de agentes com elevado conhecimento da área a evacuar.
\\\textbf{Cenário:} 
\textit{scenario1.xml}
\\\textbf{Mapa:} 
\textit{map\_report.map}

Esta experiência consistiu na colocação num espaço de 15 agentes do tipo \textit{IndependentKnowledgeable} e \textit{DependentKnowledgeable}, com um elevado nível de conhecimento da área e baixos níveis de pânico.
...
Como seria expectável numa situação em que todos conhecem bem onde se encontram as saídas e não existindo pânico, a evacuação decorre sem problemas, não se tendo registado nenhum pedido de direções ou ajuda, nem qualquer empurrão.
