...
\begin{table}[H]
	...
	\begin{tabular}{@{}lll@{}}
	    ...
	    \rowcolor[HTML]{FFFFFF} 
	    \begin{tabular}[c]{@{}l@{}}Pedido de\\Direções\end{tabular} & \begin{tabular}[c]{@{}l@{}}Um agente , por ser pouco independente ou ter pouco\\conhecimento da área, pede direções a agentes\\ na sua proximidade.\end{tabular}  \\ \midrule 
	    \rowcolor[HTML]{FFFFFF} 
...
\end{table}
	...
	Como esperado, observou-se que o agente com menor conhecimento da área efetuou um pedido de direções, que despoleta uma resposta por parte do outro agente. Recebendo esta resposta, o agente que efetuou o pedido atualiza o seu conhecimento da área com base na informação que contém e num fator de aquisição de conhecimento, como detalhado. Na Figura \ref{directions_graph} é possível verificar o aumento do conhecimento médio.
